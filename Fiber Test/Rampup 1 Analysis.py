...
cal1 = np.mean(no_nan(cal1_arr))
cal2 = np.mean(no_nan(cal2_arr))
...
Pv1_err = cal1_err / cal1 * Pv1
Pv2_err = cal2_err / cal2 * Pv2
...
tprint(f'Ch1_avg = {cal1:.4g} uWV^-1')
tprint(f'Ch1_err = {cal1_err:.4g} uWV^-1')
tprint(f'Ch1_ptp = {cal1_ptp:.4g} uWV^-1')
tprint(f'Ch2_avg = {cal1:.4g} uWV^-1')
tprint(f'Ch2_err = {cal1_err:.4g} uWV^-1')
tprint(f'Ch2_ptp = {cal1_ptp:.4g} uWV^-1')
